...
| 운영 체제 | 다음 중 하나의 라이센스 버전을 실행하는 컴퓨터: * CentOS 8 Stream(64비트), CentOS 9 Stream, SELinux * OpenSUSE Leap 15.3 - 15.5(64비트) * Oracle Linux 8.6 - 8.8, 9.1 - 9.4 - 9.4(64비트) * Red Hat Enterprise Linux 8.6 - 9.4 - 9.4, SUSE Linux 9 - 64 비트 Linux * 9.4 - 64 비트 Linux * 9.4, SUSE Linux 8 전용 서버가 권장됩니다. 
