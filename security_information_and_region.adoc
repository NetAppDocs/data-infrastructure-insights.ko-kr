...
* 사용자 액세스 데이터
+
NetApp 콘솔이 지역별 Data Infrastructure Insights 사이트와 통신할 수 있도록 하는 인증 및 액세스 정보(사용자 권한 부여와 관련된 데이터 포함)입니다.
...
* NetApp 콘솔이 사용자 권한 부여와 관련된 모든 내용을 포함하여 지역별 Data Infrastructure Insights 사이트와 통신할 수 있도록 하는 정보입니다.
