...
summary: Pure FlashBlade Storage 데이터 수집기 구성 
---
...
[role="lead"]
Data Infrastructure Insights는 Pure Storage FlashBlade 데이터 수집기를 사용하여 REST API 버전 2를 제공하는 FlashBlade 클러스터에서 인벤토리 및 성능 데이터를 수집합니다.
