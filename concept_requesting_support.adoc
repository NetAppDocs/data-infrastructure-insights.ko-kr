...
지원 세션 중에 NetApp 지원 엔지니어가 Data Infrastructure Insights 사이트에 액세스할 수 있도록 확인란을 선택하는 것이 좋습니다. 이렇게 하면 엔지니어가 문제를 해결하고 신속하게 해결할 수 있습니다. 지원 엔지니어가 사이트에 액세스하는 동안 모든 관리자 수준 기능을 수행할 수 있습니다.

문제가 해결되었거나 지원 세션이 종료되면 해당 확인란의 선택을 해제할 수 있습니다.
