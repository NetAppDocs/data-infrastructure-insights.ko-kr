...
NOTE: 이 수집기는 더 이상 사용되지 않습니다. 2027년 1월부터는 더 이상 이용할 수 없습니다.



== 설치

. *관찰성 > 수집기*에서 *+데이터 수집기*를 클릭합니다.  Nginx를 선택하세요.
+
...
Nginx 메트릭 수집에는 Nginx가 필요합니다.link:http://nginx.org/en/docs/http/ngx_http_stub_status_module.html["http_stub_status_module"] 활성화됩니다.

추가 정보는 다음에서 찾을 수 있습니다.link:http://nginx.org/en/docs/["Nginx 문서"] .
