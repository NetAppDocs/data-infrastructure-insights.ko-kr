...
link:media/DII_ON-PREM_Notice_Nov2025.pdf["Data Infrastructure Insights (이전 Cloud Insights)에 대한 알림, window=_blank"]

link:media/DII_WS_Notice_Nov2025.pdf["Workload Security(이전 Cloud Secure)에 대한 알림, window=_blank"]
