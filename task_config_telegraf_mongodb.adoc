...
[role="lead"]
Data Infrastructure Insights는 이 데이터 수집기를 사용하여 MongoDB에서 메트릭을 수집합니다.
...
정보는 에서 찾을 link:https://docs.mongodb.com/["MongoDB 설명서"]수 있습니다.
...
정보는 페이지에서 찾을 수 link:concept_requesting_support.html["지원"]있습니다.
