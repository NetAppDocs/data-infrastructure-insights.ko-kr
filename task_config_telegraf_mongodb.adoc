...
. *관찰성 > 수집기*에서 *+데이터 수집기*를 클릭합니다.  MongoDB를 선택하세요.
+
...
정보는 다음에서 찾을 수 있습니다.link:https://docs.mongodb.com/["MongoDB 문서"] .
...
정보는 다음에서 찾을 수 있습니다.link:concept_requesting_support.html["지원하다"] 페이지.
