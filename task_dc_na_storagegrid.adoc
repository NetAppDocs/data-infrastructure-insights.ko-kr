...
| StorageGRID 호스트 IP 주소 | StorageGRID의 관리 IP 주소(Grid Manager) 


| 사용자 이름 | StorageGRID(Grid Manager)에 로그인하는 데 사용되는 이름 


| 비밀번호 | StorageGRID(Grid Manager)에 로그인하는 데 사용되는 비밀번호 
|===
